...
//    GridView gridView;
    ...
    private List<StudyObject> getStudies(){
        ...
        studyList.add(new StudyObject("영어 면접", "영어", "분당","매주 토요일", "이런 비가 ", "안녕하세요. 현재 러문 복수전공하고있는 10학번입니다. 방학 때 FLEX 준비를 해서 얼마 전에 시험 보았구요, 이번 주부터는 토르플 2단계를 준비해서 2학기 안에 한 번 보는 게 목표입니다. 원래 세 명이서 진행하다가 현재 2명이구요, 정막래 교수님 토르플 2단계 문제집으로 진행합니다. 저는 러시아로 한 학기 교환학생을 다녀왔고 나머지 한 분은 어렸을 때 우즈벡에서 살다 오셨어요. 저는 공부 안 한 지가 오래되어서 거의 초보 수준이라 이번 학기 수업 들으면서 다시 쌓아 올릴 생각입니다. 체류 경험 있으신 분도 없으신 분도 모두 환영합니다. 성실하게 임해주실 분들 찾습니다. "));
